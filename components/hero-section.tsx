...
import { Download, Linkedin, Mail, ChevronDown, Briefcase, FolderOpen, Award, FileText, MapPin } from "lucide-react"
        ...
        <svg className="absolute w-full h-full opacity-10" viewBox="0 0 1000 1000">
          <defs>
            <linearGradient id="circuit-gradient" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" stopColor="oklch(0.7 0.15 220)" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="space-y-4">
              ...
              <motion.div
                ...
                className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-secondary/80 border border-border/50 text-sm"
              >
                <span className="relative flex h-2 w-2">
                  <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-green-400 opacity-75"></span>
                  <span className="relative inline-flex rounded-full h-2 w-2 bg-green-500"></span>
                </span>
                <span className="text-muted-foreground">Open to 2026 embedded / hardware roles</span>
              </motion.div>
              ...
              >
                Building reliable systems where hardware meets intelligence.
              </motion.p>
            </div>
            ...
            >
              MSc Embedded Systems student at the University of Twente with 2+ years of industry experience in embedded hardware, firmware development, PCB design, robotics platforms, FPGA systems, and real-time sensing applications.
            </motion.p>
          ...
          >
            <div className="relative">
              ...
              {/* Circuit ring decoration */}
              <svg className="absolute -inset-8 w-[calc(100%+64px)] h-[calc(100%+64px)]" viewBox="0 0 400 400">
                <motion.circle
                  cx="200"
                  cy="200"
                  r="180"
              ...
              {/* Avatar container */}
              <div className="relative w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden border-2 border-primary/30 glow-accent">
                <img
        ...
        >
          {stats.map((stat, index) => (
            <motion.div
              ...
              className="group relative p-4 md:p-6 rounded-xl bg-card/50 border border-border/50 hover:border-primary/50 transition-all duration-300"
            >
